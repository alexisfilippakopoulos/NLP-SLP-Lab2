...
class BaselineDNN(nn.Module):
    ...
    def __init__(self, output_size, embeddings, trainable_emb=False):
        ...
        num_embeddings, embedding_dim = embeddings.shape  # EX4
        ...
        self.linear = nn.Linear(embedding_dim, 1000)
        self.relu = nn.ReLU()
...
class LSTM(nn.Module):
    ...
    def forward(self, x, lengths):
        ...
        representations = torch.zeros(batch_size, self.representation_size, device=ht.device, dtype=ht.dtype)
